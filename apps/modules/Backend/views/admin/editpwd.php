...
<div class="pad_10">
	<form action="<?php echo YUrl::createBackendUrl('Admin', 'editPwd'); ?>" method="post" name="myform" id="myform" autocomplete="off">
		<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
			...
			<tr>
				<th width="80">旧密码：</th>
				<td><input type="password" name="old_pwd" id="old_pwd" size="20"
					class="input-text" value=""></td>
			</tr>
			<tr>
				<th width="80">新密码：</th>
				<td><input type="password" name="new_pwd" id="new_pwd" size="20"
					class="input-text" value=""></td>
			</tr>
			<tr>
				<th width="80">确认密码：</th>
				<td><input type="password" name="confirm_pwd" id="confirm_pwd"
					size="20" class="input-text" value=""></td>
			</tr>
			<tr>
				<td width="100%" align="center" colspan="2"><input id="form_submit"
					type="button" class="btn_submit" name="dosubmit" value=" 提交 " /></td>
			</tr>
		</table>
