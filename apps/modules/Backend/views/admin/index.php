...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addAdmin', '<?php echo YUrl::createBackendUrl('Admin', 'add'); ?>', '添加管理员', 450, 290)"><em>添加管理员</em></a>
...
<div class="pad-lr-10">
	...
	<form name="searchform" action="<?php echo YUrl::createBackendUrl('Admin', 'index'); ?>" method="get">
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
						...
						<td align="center"><a href="###"
							...
							onclick="deleteDialog('delteAdmin', '<?php echo YUrl::createBackendUrl('Admin', 'delete', ['admin_id' => $item['admin_id']]); ?>', '<?php echo $item['realname'] ?>')"
							title="删除">删除</a></td>
					</tr>
    <?php endforeach; ?>
    </tbody>
...
function edit(id, name) {
	...
	postDialog('editAdmin', page_url, title, 460, 290);
}
</script>
</body>
</html>