...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addCategory', '<?php echo YUrl::createBackendUrl('Category', 'add'); ?>', '添加分类', 450, 290)"><em>添加分类</em></a>
		...
		<table width="100%" cellspacing="0" class="search-form">
			<tbody>
     		...
     		<?php foreach ($cat_type_list as $type_id => $type_name): ?>
            	<option <?php echo $type_id==$cat_type ? 'selected="selected"' : ''; ?> value="<?php echo $type_id; ?>"><?php echo $type_name; ?></option>
            <?php endforeach; ?>
        	</select>
							</p>
						</div>
			...
			<table width="100%" cellspacing="0">
				...
				<tbody>
					<?php foreach ($list as $cat): ?>
						<tr>
						<td align='center'>
							<input name='listorders[<?php echo $cat['cat_id']; ?>]' type='text' size='3' value='<?php echo $cat['listorder']; ?>' class='input-text-c'>
						</td>
						...
						<td align='center'><?php echo $cat_type_list[$cat['cat_type']]; ?></td>
						...
						<td align='center'><?php echo $cat_type_list[$sub_m['cat_type']]; ?></td>
						...
						<td align='center'><?php echo $cat_type_list[$ss_m['cat_type']]; ?></td>
