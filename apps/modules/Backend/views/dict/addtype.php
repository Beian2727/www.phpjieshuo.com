...
<div class="pad_10">
	<form action="<?php echo YUrl::createBackendUrl('Dict', 'addType'); ?>"
		method="post" name="dialog_form" id="myform">
		<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
			<tr>
				<th width="100">字典名称：</th>
				<td><input type="text" name="type_name" id="dict_type_name"
					size="40" class="input-text" value=""></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><textarea name="description" id="dict_description"
						style="width: 292px;" rows="5" cols="50"></textarea></td>
			</tr>
			<tr>
