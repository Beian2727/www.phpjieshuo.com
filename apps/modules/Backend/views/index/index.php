...
<html xmlns="http://www.w3.org/1999/xhtml" class="off">
	<head>
		...
		.bg_btn {
			background: url(<?php echo YUrl::assets('image', '/backend/icon2.jpg');?>) no-repeat;
			width: 32px;
			height: 32px;
		}
		</style>
		...
		<div class="col-auto mr8">
			...
			<div class="col-1">
				<div class="content" style="position: relative; overflow: hidden">
					<iframe name="right" id="rightMain" src="/Backend/Index/right" frameborder="false" scrolling="auto"
						style="border: none; margin-bottom: 30px; height: 505px;"
						width="100%" height="auto" allowtransparency="true">
					</iframe>
				</div>
			</div>
		</div>
