					...
					<td>
						<div class="explain-col">
							<p style="margin-top: 10px;">
								错误码： <input type="text" value="<?php echo $search['errcode']; ?>" class="input-text" name="errcode" placeholder="" /> 
...
Calendar.setup({
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
						...
						<td align="center"><?php echo $item['log_time']; ?></td>
						...
						<td align="center"><a
							href="javascript:postDialog('viewdetail', '<?php echo YUrl::createBackendUrl('Log', 'detail', ['log_id' => $item['log_id']]); ?>', '查看日志详情', 800, 600);">[详情]</a></td>
					</tr>
    <?php endforeach; ?>
    </tbody>
			</table>
