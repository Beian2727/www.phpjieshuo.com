...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addNews', '<?php echo YUrl::createBackendUrl('News', 'add'); ?>', '添加文章', 900, 600, true)"><em>添加文章</em></a>
...
Calendar.setup({
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
						...
						<td align="center">
							<a target="_blank" href="<?php echo $item['image_url']; ?>">
								<img width="120" height="120" src="<?php echo $item['image_url']; ?>" />
							</a>
						</td>
...
function edit(id, name) {
	...
	postDialog('editNews', page_url, title, 900, 600, true);
}
</script>
</body>
</html>