...
<form name="myform"
	action="<?php echo YUrl::createBackendUrl('Role', 'setPermission'); ?>"
	method="post" id="setPermissionForm">
	<div class="pad-lr-10">
				...
				<tbody>
					<?php foreach ($list as $menu): ?>
						...
						<td align='left'><label><input
								<?php echo in_array($menu['menu_id'], $priv_menu_list) ? 'checked="checked"' : ''; ?>
								id="<?php echo $menu['menu_id']; ?>"
								parentid="<?php echo $menu['parentid']; ?>" name='menuid[]'
								type='checkbox' size='3' value='<?php echo $menu['menu_id']; ?>'><?php echo $menu['name']; ?></label></td>
					</tr>
						...
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input
								<?php echo in_array($sub_m['menu_id'], $priv_menu_list) ? 'checked="checked"' : ''; ?>
								id="<?php echo $sub_m['menu_id']; ?>"
								parentid="<?php echo $sub_m['parentid']; ?>" name='menuid[]'
								type='checkbox' size='3'
								value='<?php echo $sub_m['menu_id']; ?>'>├─ <?php echo $sub_m['name']; ?></label></td>
					</tr>
						...
						<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input
								<?php echo in_array($ss_m['menu_id'], $priv_menu_list) ? 'checked="checked"' : ''; ?>
								id="<?php echo $ss_m['menu_id']; ?>"
								parentid="<?php echo $ss_m['parentid']; ?>" name='menuid[]'
								type='checkbox' size='3' value='<?php echo $ss_m['menu_id']; ?>'>├─ <?php echo $ss_m['name']; ?></label>
						</td>
					</tr>
						<?php endforeach; ?>
						<?php endif; ?>
