...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addRole', '<?php echo YUrl::createBackendUrl('Role', 'add'); ?>', '添加角色', 450, 250)"><em>添加角色</em></a>
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
						...
						<td align="center"><a href="###"
							...
							onclick="deleteDialog('deleteRole', '<?php echo YUrl::createBackendUrl('Role', 'delete', ['roleid' => $item['roleid']]); ?>', '<?php echo $item['rolename'] ?>')"
							title="删除">删除</a> | <a href="###"
							onclick="setRoleValue(<?php echo $item['roleid'] ?>, '<?php echo $item['rolename'] ?>')"
							title="角色权限管理">角色权限管理</a></td>
					</tr>
    <?php endforeach; ?>
    </tbody>
			</table>
