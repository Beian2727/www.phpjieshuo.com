...
<div class="pad_10">
	<form action="<?php echo YUrl::createBackendUrl('User', 'forbid'); ?>"
		method="post" name="myform" id="myform">
		<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
			<tr>
				<th width="100">封禁类型：</th>
				<td><select name="ban_type" id="ban_type">
			...
			<tr class="ban_time" style="display: none;">
				...
				<td><input type="text" name="ban_start_time" id="ban_start_time"
					value="" size="20" class="date input-text" /></td>
			</tr>
			<tr class="ban_time" style="display: none;">
				<th>封禁结束时间：</th>
				<td><input type="text" name="ban_end_time" id="ban_end_time"
					value="" size="20" class="date input-text" /></td>
			</tr>
			<tr>
