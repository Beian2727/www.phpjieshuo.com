...
function uploadImage(filesUrl, baseJsUrl, ImgId, saveImgId, width, height, uploadUrl) {
    ...
    var uploader = new ss.SimpleUpload({
      ...
      onSubmit: function() {
    	  previewImage.empty();
    	  previewImage.append('<img style="width:' + width + 'px;height:' + height + 'px;" src="' + baseJsUrl + 'AjaxUploader/upload_loading.png">');
        },
      onComplete: function(filename, response) {
          ...
          if (!response) {
        	  previewImage.empty();
        	  previewImage.append('<img style="width:' + width + 'px;height:' + height + 'px;" src="' + baseJsUrl + 'AjaxUploader/upload_error.png">');
              return;
          }
